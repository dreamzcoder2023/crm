...
class LabourDeleteExpensesExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    */
    ...
    public function collection()
    {
      ...
      ->select('expenses.*', 'category.name as category_name', 'project_details.name as project_name',
       ...
       'users_add.last_name as last','l.name as labour_name','labour_ad.first_name as labour_first',
