...
class VendorUnpaidExpensesExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    */
    ...
    public function collection()
    {
        ...
        ->when($this->project_filter, function($query,$project){
          $query->where('expenses.project_id', $project);
        })
        ->when($this->user_filter, function($query,$user){
          $query->where('expenses.user_id', $user);
        })
