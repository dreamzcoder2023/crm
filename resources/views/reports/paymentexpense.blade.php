        ...
        <div class="container text-center">
            ...
            <div class="col">
                ...
                <div class="col-1"> <!-- Reduce the column size from 1 to 2 -->
                    <button type="button" class="btn btn-success" id="paymentexpense-export">Excel</button>
                </div>
                <div class="col-1"> <!-- Reduce the column size from 1 to 2 -->
                    <button type="button" class="btn btn-primary" id="paymentexpense-pdf">Pdf</button>
                </div>
                <div class="col">
