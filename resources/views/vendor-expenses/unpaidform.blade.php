...
<h4 class="fw-bold py-3 mb-4">
  ...
  <div class="col-md-12">
      ...
      <li class="nav-item"><a class="nav-link active" href="{{route('vendor-expenses-unpaid-history')}}"><i class="bx me-1"></i> Back</a></li>
...
<div class="row">
  ...
  <div class="col-xxl">
    <div class="card mb-4" style="top:30px">
      ...
      <div class="card-body">
<form name="UnpaidSubmit" action="{{route('vendor-expenses-unpaid-store')}}" id="UnpaidSubmit" method="post" >
            @csrf
  <div class="col-xl">
