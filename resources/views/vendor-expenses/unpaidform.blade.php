...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Vendor Unpaid Expenses
    </h4>
    <div class="row" style="position:absolute; top:150px; right:50px ">
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                <li class="nav-item"><a class="nav-link active" href="{{ route('vendor-expenses-unpaid-history') }}"><i
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" oninput="amountcheck(this.value)" onkeypress="allowNumbersOnly(event)" id="amount"
