...
@section('content')
    <div class="container-fluid">
        <div class="row align-items-center mt-3" style="margin-top: -25px;">
            <div class="col-md-6">
                <h4 class="fw-bold" style="font-size:13px;">
                    <span class="fw-light text-dark">Vendor History</span>
                </h4>
            </div>
            <div class="col-md-6 text-end">
                <a href="{{ route('vendor-expenses-advance-history') }}" class="btn btn-primary">Back</a>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div id="filter-section" >
                    ...
                    <div class="col-md-2">
                        ...
                        <select id="member" name="member_id" class="form-control">
                            ...
                            @foreach ($user_list as $member)
                                <option value="{{ $member->id }}" {{ request('member_id') == $member->id ? 'selected' : '' }}>{{ $member->first_name }} {{ $member->last_name }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="mt-3 text-end">
                    ...
                    <a class="btn btn-danger" href="{{ route('vendor.vendor-history',$id) }}">
