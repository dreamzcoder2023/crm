    ...
    <div class="authentication-inner">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- /Logo -->
          <h4 class="mb-2">Reset Password</h4></div>
          <div class="display:flex;">
          {{-- <p class="mb-4">Create an account as a new client.</p> --}}
          </div>

          <form id="formAuthentication" class="mb-3" action="{{route('update-password')}}" method="post" autocomplete="off"  enctype="multipart/form-data">
            @csrf
...
<script type="text/javascript">
  ...
  $('#formAuthentication').submit(function(e) {
    ...
    var passwordname=false,conname=false;
