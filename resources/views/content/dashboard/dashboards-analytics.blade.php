...
@section('content')
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <span class="h3 font-bold mb-0"
                                    style="font-size: 10px; font-weight:800;color:darkcyan;width:40px;">You Currently Check
                                    Out</span>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row">
                            <div class="col">
                                <span class="h6 font-semibold text-muted text-sm d-block mb-2"
                                    style="font-weight: 800;color:black !important;">Check Out</span>
                                <span class="h3 font-bold mb-0"
                                    style="font-size: 13px; font-weight:800;color:darkcyan;width:40px;">You
                                    Currently Check Out</span> <br>
                                <p
                                    style="color:red; font-weight:800 !important; font-size:12px;margin-top:6px;font-style:bold ;">
                                    <b style="color:red; font-weight:800 !important; font-size:12px;font-style:bold ;">Good
                                        Bye, {{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</b>
                                </p>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h3 font-bold mb-0"
                                        style="font-size: 14px; font-weight:800;color:white;width:20px;">{{ $checking->created_at->format('d:m:Y h:i:s A') }}</span>
                                    <br>
                                    <p style="color:yellow; font-weight:800; font-size:12px;">Welcome,
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col text-center">
                            ...
                            <span class="h6 font-semibold text-muted text-sm d-block mb-2"
                                style="color: black !important;margin-top:10px; font-weight:600 !important;text-align:center;">Team
                                Members</span>
                            <!-- Hidden member information -->
                            <span class="h3 font-bold mb-0 member-info"
                                style="display: none;font-size:22px; font-weight:900;color:darkcyan">{{ $member }}</span>
                        </div>
                        <div class="col-auto">
                            <a class="dropdown-item" href="{{ route('user-index') }}">
                                <div class="icon icon-shape text-white text-lg rounded-circle"
                                    style="background-color:sandybrown;border:2px solid white;">
    ...
    <!-- income and expenses daily chart -->
    <div class="row" style="margin:10px; padding:10px;">

        <!-- Order Statistics -->
        <div class="col-4 ">
            <div class="card   shadow border-0" style="height:100px;border:2px solid skyblue !important">
                <div class="card-body">
                    <div class="row">
                        <div class="col text-center">
                            <!-- Initially centered text -->
                            <span class="h6 font-semibold text-muted text-sm d-block mb-2"
                                style="color: black !important;margin-top:10px; font-weight:600 !important;text-align:center;">
                                Members</span>
                            <!-- Hidden member information -->
                            <span class="h3 font-bold mb-0 member-info"
                                style="font-size:22px; font-weight:900;color:skyblue">{{ $member }}</span>
                        </div>
                        <div class="col-auto" style="margin-top:-40px;">
                            <a class="dropdown-item" href="{{ route('user-index') }}">
                                <div class="icon icon-shape text-white text-lg rounded-circle"
                                    style="background-color:skyblue;border:2px solid skyblue; ">
                                    <i class="bi bi-people-fill" style="color: #ffffff;"></i>
                                </div>
                            </a>
                        </div>
                ...
                <div class="card   shadow border-0" style="height:100px;border:2px solid #ffc107 !important;margin-top:90px;">
                  <div class="card-body">
                      <div class="row">
                          <div class="col text-center">
                              <!-- Initially centered text -->
                              ...
                              <!-- Hidden member information -->
                              <span class="h3 font-bold mb-0 member-info"
                                  style="font-size:22px; font-weight:900;color:#ffc107">{{ $member }}</span>
                          </div>
                          <div class="col-auto" style="margin-top:-40px;">
                              <a class="dropdown-item" href="{{ route('user-index') }}">
                                  <div class="icon icon-shape text-white text-lg rounded-circle"
                                      style="background-color:#ffc107;border:2px solid #ffc107; ">
                                      <i class="bi bi-people-fill" style="color: #ffffff;"></i>
                                  </div>
                              </a>
                          </div>
                                ...
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    ...
                                    <div class="user-progress d-flex align-items-center gap-1">
                                        <h6 class="mb-0" style="font-weight: ">
                                            {{ empty($transfer->total_amount) == 0 ? 0 : $transfer->total_amount }}</h6>
    ...
    <div class="row" style="margin:10px; padding:10px;">
            ...
            <div class="card h-100 inc">
                <div class="card-header d-flex align-items-center justify-content-between pb-2">
                    <div class="card-title mb-0">
                        <h5 class="m-0 me-2" style="color:black; margin-bottom:2px;font-size:18px !important;"> <svg
                ...
                <div class="card-body">
                    ...
                    <ul class="p-0 m-0">
                        <li class="d-flex mb-4 pb-1">
                            <div class="avatar flex-shrink-0 me-3">
                                <span class="avatar-initial rounded bg-label-primary"><i class="fa fa-folder-open-o"
                                        aria-hidden="true" style="color:green"></i></span>
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                            <div class="avatar flex-shrink-0 me-3">
                                <span class="avatar-initial rounded bg-label-primary"><i class="fa fa-folder-o"
                                        aria-hidden="true" style="color:red"></i></span>
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                    ...
                    <ul class="nav nav-pills" role="tablist">
                        ...
                        <li class="nav-item">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                ...
                                aria-controls="navs-tabs-line-card-expenses" aria-selected="true"
                                style="color:black">Expenses</button>
                        </li>
        ...
        <!-- Transactions -->
        <div class="col-md-6 col-lg-4 order-2 mb-4">
            <div class="card h-80  inccc" style="overflow: auto !important; overflow-x:scroll; overflow-y:scroll;">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="card-title m-0 me-2" style="color:black">Transactions</h5>
                    <div class="dropdown">
                        <button class="btn p-0" type="button" id="transactionID" data-bs-toggle="dropdown"
    ...
    <div class="row">
        ...
        <div class="col-4">
            <div id="containerr" style="height: 400px; width: 500px;"></div>
        </div>
