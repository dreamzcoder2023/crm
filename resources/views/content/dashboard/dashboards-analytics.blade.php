  ...
  <div class="row">
        ...
        @if ($checking == '')
            <div class="col-md-4 col-xl-3 mb-4">
                <div class="card cards shadow border-0" style="background-color:orange;width:98%;height:188px;">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-3 text-center">

                                <img src="{{ url('assets/img/icons/refer.png') }}" style="height: 40px;margin-top:-64px;">
                            ...
                            <div class="col pr-0">
                                <form action="{{ route('checking.store') }}" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-light"
                                        style="margin-bottom: 30px; margin-left:30px; color:black;">Check In</button>
                                </form>
                                <span class="h6 mb-0 mt-3" style="font-size:15px; color:white;">You Currently Check
                                    Out</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-4 col-xl-3">
                <div class="card cards shadow border-0" style="background-color:orange; width:98%;height:188px;">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-3 text-center">
                                <img src="{{ url('assets/img/icons/refer.png') }}" style="height:25px;margin-top:-44px;">
                            </div>
                            <div class="col pr-0">
                                <form action="{{ route('checking.store') }}" method="POST">
                                    @csrf
                                ...
                                <span class="h6 mb-0 mt-3" style="font-size:15px; color:white; margin-left:20px;">You
        ...
        @if ($checking != '')
            @if ($checking->notes == 0)
                <div class="col-md-4 col-xl-3">
                    <div class="card cards shadow border-0" style="background-color:#699dce;width:98%;height:188px; ">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-3 text-center">
                                    <img src="{{ url('assets/img/icons/turn-off.png') }}"
                                        style="height:25px;margin-top:-44px;">
                                </div>
                                ...
                                <div class="col pr-0">
                                    <form action="{{ route('checking.update', $checking->id) }}" method="POST">
                                        ...
                                        @method('PUT')
                                        <button type="submit" class="btn btn-light"
                                            style="margin-bottom: 30px; margin-left:30px; color:black;">Check Out</button>
                                    </form>
                                   <center> <span class="h6 mb-0 mt-3"
                                        style="color:white; margin-left:16px;">{{ $checking->created_at->format('d:m:Y h:i:s A') }}</span></center>
                                </div>
            ...
            <div class="row">
                @role('Admin')
                    <div class="col-md-4 mb-4">
                        <div class="card" style="width:98%;height:188px;">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="{{ asset('assets/img/icons/unicons/user.png') }}" alt="chart success"
                                            class="rounded">
                                    </div>
                                    <div class="dropdown">
                                ...
                                <span class="fw-semibold d-block mb-1">Team Members</span>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card" style="width:98%;height:188px;">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5 class="card-title text-nowrap mb-1">{{ $project_open }}</h5>
                                        <small class="text-success fw-semibold"><i class=""></i> open</small>
                                    </div>
                                    <div class="col-md-6 border-start">
                                        <h5 class="card-title text-nowrap mb-1">{{ $project_close }}</h5>
                                        <small class="text-success fw-semibold"><i class=""></i> close</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card" style="width:98%;height:188px;">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0">
                                    <img src="{{ asset('assets/img/icons/unicons/redcash.png') }}" alt="chart success"
                                        class="rounded">
                                </div>
                                <div class="dropdown">
                                    <button class="btn p-0" type="button" id="cardOpt3" data-bs-toggle="dropdown"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                        <a class="dropdown-item" href="{{ route('expenses-history') }}">View More</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card" style="width:98%;height:188px; ">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="{{ asset('assets/img/icons/expense.png') }}" alt="chart success"
                                            class="rounded">
                                    </div>
                                    <div class="dropdown">
                                        <button class="btn p-0" type="button" id="cardOpt3" data-bs-toggle="dropdown"
                                ...
                                <h6 class="card-title mb-2">{{ $paid_amt }}</h6>
                                <small class="text-success fw-semibold">last 30 days</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 mb-4">
                        <div class="card" style="width: 98%; height: 188px; ">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="{{ asset('assets/img/icons/transfer.png') }}" alt="slack"
                                ...
                                <span>Transfer</span>
                                <h4 class="card-title text-nowrap mb-1">{{ $monthly_transfer }}</h4>
                                <small class="text-success fw-semibold">last 30 days</small>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="card-title d-flex align-items-start justify-content-between">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                                <a class="dropdown-item" href="{{ route('client-summary') }}">View More</a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card" style="width: 98%;height: 188px;">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-title mb-2">{{ $wallet }} </h6>
                                </div>
                            </div>
                        </div>
                    @endrole
