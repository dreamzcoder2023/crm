                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <span class="h3 font-bold mb-0 member-infoo"
                                style="display: none;font-size:22px; font-weight:900;margin-left:50px;color:darkcyan">{{ $unpaid_amt }}</span>
                        </div>
                        <div class="col-auto">
                            <a class="dropdown-item" href="{{ route('expenses-history') }}">
                                <div class="icon icon-shape  text-white text-lg rounded-circle"
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <span class="h3 font-bold mb-0 member-infooo"
                                style="display: none;font-size:22px; font-weight:900;margin-left:50px;color:darkcyan">{{ $wallet }}</span>
                        </div>
                        <div class="col-auto">
                            <a class="dropdown-item" href="{{ route('user-index') }}">
    ...
    <div class="row" style="margin:10px; padding:10px;">
        ...
        <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-4">
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between pb-0">
                    <div class="card-title mb-0">
                        <h5 class="m-0 me-2"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid icon-16">
                                <rect x="3" y="3" width="7" height="7"></rect>
                                <rect x="14" y="3" width="7" height="7"></rect>
                                <rect x="14" y="14" width="7" height="7"></rect>
                                <rect x="3" y="14" width="7" height="7"></rect>
