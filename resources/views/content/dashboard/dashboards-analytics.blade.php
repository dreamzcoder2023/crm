          ...
          <div class="col-auto">
            ...
            <form action="{{ route('checking.store') }}" method="POST">
              ...
              <div class="icon icon-shape submit-icon text-white text-lg rounded-circle" style="background-color:darkcyan;border:2px solid white">
                <i class="bi bi-people submit-icon"></i>
              </div>
            </form>
  ...
  <div class="col-xl-3 col-sm-6 col-12">
    <div class="card cards shadow border-0">
      <div class="card-body">
        <div class="row">
          <div class="col">
            <span class="h6 font-semibold text-muted text-sm d-block mb-2" style="font-weight: 800;">Check Out</span>
            <span class="h3 font-bold mb-0" style="font-size: 10px; font-weight:800;color:darkcyan;width:40px;">You
  ...
  <div class="col-xl-3 col-sm-6 col-12">
    <div class="card cards shadow border-0" style="background-color: darkcyan;">
      <div class="card-body">
        <div class="row">
          <div class="col">
            <span class="h6 font-semibold text-muted text-sm d-block mb-2" style=" color:antiquewhite;font-weight:800;">Check-in</span>
            <span class="h3 font-bold mb-0" style="font-size: 10px; font-weight:800;color:white;width:20px;">{{ $checking->created_at->format('d:m:Y h:i:s A') }}</span>
          </div>
          <div class="col-auto">
            ...
            <form action="{{ route('checking.update', $checking->id) }}" method="POST">
              ...
              <div class="icon icon-shape submit-icon text-white text-lg rounded-circle" style="background-color:white;border:2px solid white">
                <i class="bi bi-people submit-icon" style="color: darkcyan;font-weight:800"></i>
              </div>
  ...
  <div class="col-xl-3 col-sm-6 col-12">
    <div class="card cards shadow border-0">
      <div class="card-body">
        <div class="row">
          <div class="col">
            <span class="h6 font-semibold text-muted text-sm d-block mb-2">Team Members</span>
            <span class="h3 font-bold mb-0">{{ $member }}</span>
          </div>
          <div class="col-auto">
  ...
  <div class="col-xl-3 col-sm-6 col-12">
    <div class="card cards shadow border-0">
      <div class="card-body">
        <div class="row">
          <div class="col">
            <span class="h6 font-semibold text-muted text-sm d-block mb-2">Unpaid Amount</span>
            <span class="h3 font-bold mb-0">{{ $unpaid_amt }}</span>
          </div>
          <div class="col-auto">
  ...
  <div class="col-xl-3 col-sm-6 col-12">
    <div class="card cards shadow border-0">
      <div class="card-body">
        <div class="row">
          <div class="col">
            <span class="h6 font-semibold text-muted text-sm d-block mb-2">Wallet Balance</span>
            <span class="h3 font-bold mb-0">{{ $wallet }}</span>
          </div>
          <div class="col-auto">
