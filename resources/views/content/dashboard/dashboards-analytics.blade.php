                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col pr-0">
                                    <form action="{{ route('checking.store') }}" method="POST">
                                        @csrf
                                        <button type="submit" class="btn btn-light" style="margin-bottom: 30px; margin-left:30px; color:black;">Check In</button>
                                    </form>
                                    <span class="h6 mb-0 mt-3" style="font-size:15px; color:white;">You Currently Check Out</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col pr-0">
                                    ...
                                    <span class="h6 mb-0 mt-3" style="font-size:15px; color:white; margin-left:20px;">You Currently Check Out</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
      @role('Admin')
        <div class="col-lg-4 mb-4">
            <div class="card" style="width: 92%; height:150px; left:41px">
                <div class="card-body">
        ...
        @role('Admin')
        <div class="col-lg-4 mb-4">
            <div class="card" style="width: 120%;height:150px;left: 11px;">
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
        ...
        <div class="col-lg-4 mb-4">
            ...
            <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
                            <img src="{{ asset('assets/img/icons/unicons/redcash.png') }}" alt="chart success" class="rounded">
                        </div>
                        <div class="dropdown">
                            <button class="btn p-0" type="button" id="cardOpt3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="bx bx-dots-vertical-rounded"></i>
...
<div class="col-lg-4 col-md-4 order-1">
    <div class="row">
        <div class="col-lg-6 col-md-12 col-6 mb-4">
            <div class="card" style="width: 155%; height: 192px; left: -281px;">
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
                            <img src="{{ asset('assets/img/icons/expense.png') }}" alt="chart success" class="rounded">
                        </div>
                        <div class="dropdown">
                            <button class="btn p-0" type="button" id="cardOpt3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="bx bx-dots-vertical-rounded"></i>
        ...
        <div class="col-lg-6 col-md-12 col-6 mb-4">
            <div class="card" style="width: 190%; height: 188px; left: -246px;">
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
                            <img src="{{ asset('assets/img/icons/transfer.png') }}" alt="slack" class="me-3" height="20">
                        </div>
                        <div class="dropdown">
                            <button class="btn p-0" type="button" id="cardOpt6" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="bx bx-dots-vertical-rounded"></i>
        ...
        @role('Admin')
        <div class="col-lg-6 col-md-12 col-6 mb-4">
            <div class="card" style="width: 155%;height: 192px;top: -215px;left: 40px;">
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
        ...
        @role('Admin')
        <div class="col-lg-6 col-md-12 col-6 mb-4">
            <div class="card" style="width: 227%;height: 175px;top: -215px;left: 71px;">
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
