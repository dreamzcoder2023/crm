...
@section('content')
    ...
    <div class="modal fade" id="labour_weeklypopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" data-bs-keyboard="false"
        aria-hidden="true">
        ...
        var wallet = parseFloat($('#advance_submit').attr('data-wallet')); // Assuming wallet amount is passed as a data attribute
