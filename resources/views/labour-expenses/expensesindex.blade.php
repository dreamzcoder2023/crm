...
@section('content')
                            ...
                            <div id="filter-section">
                                <!-- First Row: Filters + Search -->
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <div class="mb-3">
                                        <label for="category_id" class="">Main Category</label>
                               ...
                               <div class="d-flex justify-content-end gap-2">
                                     <a class="btn btn-danger btn-sm" href="{{ route('labour-expenses-history') }}">
                                              Reset
                                            </a>                                    
    ...
    <p class="text-end" style="margin-top: 29px; margin-right: 147px; font-size: medium;">
