...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Add Roles
</h4>
...
<div class="row">
  ...
  <div class="col-xxl">
    <div class="card mb-4" style="top:30px">
      ...
      <div class="card-body">
        <form name="createRole" action="{{route('roles.store')}}" method="post">
          @csrf
          <div class="row mb-3" >
            <label class="col-sm-2 col-form-label" for="basic-default-name">Name</label>
            <div class="col-sm-10">
              <input type="text" name="name" class="form-control" id="basic-default-name" placeholder="Enter Roles" />
            </div>
    ...
    <div class="row" style="margin-top:23px;">
        ...
        <div class="form-check col-12" >
            ...
            <input class="form-check-input" type="checkbox" name="permissions[]" value="{{ $permissionData['name'] }}" id="flexCheckDefault{{ $loop->parent->index }}-{{ $loop->index }}">
