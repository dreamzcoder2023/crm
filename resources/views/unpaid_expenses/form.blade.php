    ...
    <div class="row" style="position:absolute; top:150px; right:50px ">
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                <li class="nav-item"><a class="nav-link active" href="{{ route('unpaid-history') }}"><i class="bx me-1"></i>
                        Back</a></li>
                    ...
                    <form name="UnpaidSubmit" action="{{ route('unpaid.store') }}" id="UnpaidSubmit" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" oninput="amountcheck(this.value)" onkeypress="allowNumbersOnly(event)"
                                    id="amount" name="unpaid_amt" class="form-control" placeholder="Enter amount"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="datetimepicker1" name="current_date"
                                    value="{{ Carbon\Carbon::parse($unpaid->current_date)->format('Y-m-d') }}">
                            </div>
                            <div class="mb-3">
                                <label for="appt">Time:</label><br>
                                <input type="time" id="appt" class="form-control" name="time"
                                    value="<?php echo date('H:i', strtotime($unpaid->current_date)); ?>">
                            </div>
