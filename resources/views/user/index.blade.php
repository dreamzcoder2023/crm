...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Member Test git</span>
</h4>
    ...
    <table class="table" id="user_listing_table">
      ...
      <tbody class="table-border-bottom-0">
       ...
       <tr>
        ...
        <td>
        @can(['user-view'])
        <a  href="{{route('user-show',$user->id)}}" data-id="{{$user->id}}" class=""><i class="bi bi-view-list" style="font-size:24px"></i></a>
        @endcan
          @can(['user-edit'])
        <a class="" @if($role->model_id == Auth::user()->id) href="{{ route('user-edit',$user->id) }}" @else disabled @endif><i class="fa fa-edit" style="font-size:24px"></i></a>
        @endcan
        @can('user-delete')
