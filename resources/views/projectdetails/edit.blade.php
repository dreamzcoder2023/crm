...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Edit Project Details
</h4>
...
<div class="row">
<form name="editProject" action="{{route('project.update',$project->id)}}" id="editProject" method="post" >
            @csrf
            {{ method_field('PUT') }}
  <div class="col-xl">
    <div class="card mb-4" style="margin-top:30px;">
      ...
      <div class="card-body">
        <div class="row">
            ...
            <input type="text" id="name" name="name" class="form-control" id="basic-default-fullname" value="{{$project->name}}" placeholder="Enter project name" />
          ...
          <div class="mb-3">
            ...
            <option value="{{$client->id}}" {{$client->id == $project->client_id ? 'selected' : '' }}>{{$client->first_name}} {{$client->last_name}}</option>
            @endforeach
            </select>
          ...
          <label class="form-label" for="basic-default-phone">Payment Mode</label>
            ...
            <option value="{{$payment->id}}" {{$payment->id == $project->payment_id ? 'selected' : ''}}>{{$payment->name}}</option>
            @endforeach
            </select>
...
<div class="col-6">
            ...
            <input type="text" value="{{$project->total_amt}}" onkeypress="allowNumberOnly(this.event)"  name="total_amt"  class="form-control phone-mask" id="total_amt" placeholder="Enter total estimation" />
    ...
    <label id="amt-error" class="error" for="basic-default-amt">Total amount must be greater than advanced amount.</label>
          ...
          <div class="mb-3">
            ...
            <input  type="radio" class="gender" value="0" @if($project->project_status == 0) checked @endif id="active" name="project_status">
            <label  class="form-label" for="active">Active</label> &nbsp;
            <input type="radio" class="gender" value="1" @if($project->project_status == 1) checked @endif id="deactive" name="project_status">
