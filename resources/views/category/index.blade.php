...
<div class="row" style="position:absolute; top:180px; right:50px ">
  <div class="col-md-12">
    ...
    <ul class="nav nav-pills flex-column flex-md-row mb-3">
      <li class="nav-item"><a class="nav-link active" href="{{route('category-create')}}"><i class="bx bxs-category me-1"></i> Add Category</a></li>

    </ul>
    @endcan
  </div></div></div>
<!-- Basic Bootstrap Table -->
<div class="card" style="max-width: 1200px; margin: 46px auto; height:356px">
      ...
      <tbody class="table-border-bottom-0">
        <?php //print_r($categorys); exit; ?>
          ...
          <tr>
            ...
            <td>
            @can(['category-edit'])
            <a class="" href="{{ route('category-edit',$category->id) }}"><i class="fa fa-edit" style="font-size:24px"></i></a>
          @endcan
          @can('category-delete')
          @if(!in_array($category->id,$categorynot))
            <a data-toggle="modal" href="javascript:void(0)" data-id="{{$category->id}}" class="deleteCategory"><i class="fa fa-trash-o" style="font-size:24px; color:red"></i> </a><br/>
            @endif
            @endcan
          </td>
          @endcanany
