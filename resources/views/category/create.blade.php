...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Add Category
    </h4>
    <div class="row" style="position:absolute; top:150px; right:50px ">
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                <li class="nav-item"><a class="nav-link active" href="{{ route('category-index') }}"><i class="bx me-1"></i>
                        Back</a></li>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  name="name" class="form-control"
                                        id="basic-default-name" placeholder="Enter Category" />
                                </div>
                            </div>
                        </div>
