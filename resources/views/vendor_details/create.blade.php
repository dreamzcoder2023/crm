...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Add Vendor
    </h4>
    ...
    <div class="row">
        <div class="tab-content">
            <div class="tab-pane active" id="general-info">
                <form name="createMember" action="{{ route('vendor.store') }}" id="createMember" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea id="basic-default-message" class="form-control" name="address" placeholder="Enter Address"></textarea>
                                        </div>
