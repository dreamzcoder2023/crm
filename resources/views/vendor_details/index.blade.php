...
@section('content')
    ...
    <div style="margin-top: 30px;">
        <h4 class="fw-bold py-3 mb-4" style="margin-top:-49px;font-size:16px;color:black;">
            <span class="fw-light">Vendor Details</span>
        </h4>
        <div class="row" style="position:absolute; top:90px; right:50px ">
            <div class="col-md-12">
                @can('vendor-create')
                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                        <li class="nav-item"><a class="nav-link active" href="{{ route('vendor-create') }}"><i
                                    class="bx bx-user me-1"></i> Add Vendor</a></li>
    ...
    <div class="card" style="max-width: 1200px; margin: 40px auto;top:-26px;">
        ...
        <form id="submit-form">
            <div class="d-flex justify-content-between align-items-center m-2">
                ...
                <div class="d-flex justify-content-center align-items-center">
                    ...
                    <a class="btn btn-danger" href="{{ route('vendor-index') }}">
        ...
        @endcan --}}
                                    @can(['vendor-edit'])
                                        <a class="" href="{{ route('vendor-edit', $user->id) }}"><i
                                    ...
                                    @can('vendor-delete')
                                        ...
                                        <a data-toggle="modal" href="javascript:void(0)" data-id="{{ $user->id }}"
                                            class="deleteUser"><i class="bi bi-trash" style="font-size:24px; color:red"></i>
                                        </a><br />
                                    @endcan
                                </td>
                            @endcanany
