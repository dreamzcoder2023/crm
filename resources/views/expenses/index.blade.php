    ...
    <table class="table " id="expenses_listing_table">
      ...
      <tbody class="table-border-bottom-0">
       ...
       <tr>
        ...
        <td>@if($expense->image != '' || $expense->image != null) <a href="{{url('public/images/'.$expense->image) }}" target="_blank">View</a> @else -- @endif
        ...
        <td>@if($expense->unpaid_amt !=0)<b><a href="{{ route('unpaidex-create',$expense->id) }}"  style="color:red">{{$expense->unpaid_amt}}</a></b> @else<b> <p style="color:red">{{$expense->unpaid_amt}}</p></b>@endif</td>
