  ...
  <div class="col-xxl">
    ...
    <label id="showing_success_msg" class="success hide" style="color:green">Category added successfully.</label>
          ...
          <label class="form-label" for="basic-default-phone">Project Name</label>
           ...
           <input  type="text" id="amount" name="amount" class="form-control" placeholder="Enter amount"onkeypress="allowNumbersOnly(event)"  value="{{$expense->amount}}" />
          ...
          <label class="form-label" for="basic-default-phone">Payment Mode</label>
            ...
            <input  type="text" class="form-control" value="{{$expense->paid_amt}}" id="paid_amt" name="paid_amt"  oninput="amountcheck(this.value)"  onkeypress="allowNumbersOnly(event)">
