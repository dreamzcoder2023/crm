...
<nav class="layout-navbar {{$containerNav}} navbar navbar-expand-xl {{$navbarDetached}} align-items-center bg-navbar-theme" id="layout-navbar" style="  background-image: url('{{ asset('assets/img/backgrounds/nav.jpg') }}'); background-size:contain;background-repeat:no-repeat ">
  @endif
