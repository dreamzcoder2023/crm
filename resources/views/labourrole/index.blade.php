...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Labour Role</span>
</h4>
    ...
    <table class="table" id="user_listing_table">
      ...
      <tbody class="table-border-bottom-0">
       ...
       <tr>
        ...
        <a class=""  href="{{ route('labourrole-edit',$user->id) }}" ><i class="fa fa-edit" style="font-size:24px"></i></a>
        @endcan
